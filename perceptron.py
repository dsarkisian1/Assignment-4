        ...
        for a in range(2): #iterates over the algorithms
            ...
            if a == 0:
                if accuracy > maxAccuracy:
                    ...
                    print("Highest Perceptron accuracy so far: " + str(maxAccuracy) + ", Parameters: learning rate=" + str(w) + ", shuffle=" + str(b))
                    
            else:
                if accuracy > maxAccuracy2:
                    maxAccuracy2 = accuracy
                    print("Highest MLP accuracy so far: " + str(maxAccuracy2) + ", Parameters: learning rate=" + str(w) + ", shuffle=" + str(b))
